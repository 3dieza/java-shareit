...
class BookingDtoJsonTest {
    ...
    void testSerializeAndDeserialize() throws Exception {
        BookingDto dto = BookingDto.builder()
                ...
                .status(ru.practicum.shareitserver.booking.model.BookingStatus.APPROVED)
                .build();
        ...
        assertThat(result.getStatus()).isEqualTo(ru.practicum.shareitserver.booking.model.BookingStatus.APPROVED);
    }
}
